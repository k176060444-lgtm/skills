...
import sys, urllib.request, gzip, json, datetime, urllib.parse
...
HELP_API_LIST = "now | 7d | 24h | indices | indices3 | indices3d | air | warning | warning2 | geo | usage | weather | tomorrow | aftertomorrow"
